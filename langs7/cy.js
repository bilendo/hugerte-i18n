hugerte.addI18n("cy", {
    ...
    "Accordion": "Acordion",
    "Accordion body...": "Corff acordion...",
    "Accordion summary...": "Crynodeb acordion...",
    "Action": "Gweithred",
    ...
    "Background color {0}": "Lliw cefndir {0}",
    "Black": "Du",
    "Block": "Bloc",
    "Block {0}": "Bloc {0}",
    ...
    "Bottom": "Gwaelod",
    "Browse files": "Pori ffeiliau",
    "Browse for an image": "Pori am ddelwedd",
    "Browse links": "Pori dolenni",
    ...
    "Default": "Diofyn",
    "Delete accordion": "Dileu acordion",
    ...
    "Insert accordion": "Mewnosod acordion",
    ...
    "Press the Up and Down arrow keys to resize the editor.": "Gwasgwch y bysellau saeth Fyny a Lawr i newid maint y golygydd.",
    "Press the arrow keys to resize the editor.": "Gwasgwch y bysellau saeth i newid maint y golygydd.",
    "Press {0} for help": "Pwyswch {0} am help",
    "Preview": "Rhagolwg",
    "Previous": "Blaenorol",
    "Print": "Argraffu",
    "Print...": "Argraffu...",
    ...
    "Reveal or hide additional toolbar items": "Datgelu neu guddio eitemau bar offer ychwanegol",
    ...
    "Toggle accordion": "Toglo acordion",
    "Tools": "Offer",
    "Top": "Brig",
    ...
    "{0} characters": "{0} nod",
    "{0} columns, {1} rows": "{0} colofn, {1} rhes",
    "{0} words": "{0} o eiriau"
});
